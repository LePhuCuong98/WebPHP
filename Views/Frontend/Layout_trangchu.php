        ...
        <div class="row">
            <div class="col-xs-12 col-md-3">
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-12"><img src="Assets/frontend/images/1.jpg" class="img-thumbnail"></div>
                </div>
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-12"><img src="Assets/frontend/images/2.jpg" class="img-thumbnail"></div>
                </div>
                <div class="row">
                    <div class="col-md-12"><img src="Assets/frontend/images/3.jpg" class="img-thumbnail"></div>
                </div>
            </div>
            <div class="col-md-9">
                <!-- slide -->
                    ...
                    <div class="item">
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active"> <img src="Assets/frontend/images/la1.jpg" alt="Los Angeles"> </div>
                                <div class="item"> <img src="Assets/frontend/images/la2.jpg" alt="Los Angeles"> </div>
                                <div class="item"> <img src="Assets/frontend/images/la3.jpg" alt="Chicago"> </div>
                                <div class="item"> <img src="Assets/frontend/images/la1.jpg" alt="New York"> </div>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4">
                ...
                <div class="info">
                    ...
                    <p>Nếu sản phẩm không đảm bảo chất lượng hoặc sản phẩm không đúng tiêu chuẩn</p>
                </div>
            </div>
        </div>
    </div>
...
<footer id="footer">
    ...
    <div class="bottom-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5"> © Bản quyền thuộc về nhóm 5 Nhập môn công nghệ phần mềm</div>
